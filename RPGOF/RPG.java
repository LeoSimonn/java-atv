//Grupo: Filipe Pereira, Leonardo, Victória.
//O mago mais bolado de todo condado.
...
public class RPG {
    public static void main(String[] args) {
        ...
        System.out.println("Seja Bem-vindo ao RPG, " + nome );
        System.out.println("Seus atributos foram destribuidos em:");
            ...
            switch (escolhaAcao) {
                ...
                case 5:
                    ...
                    if (danoRaioGlacial > 0) {
                        System.out.println(nome + " deu uma de senhor gelado e causou " + danoRaioGlacial + " de dano.");
                    } else {
                        System.out.println("Sem mana irmão");
                    }
                    break;
                ...
                case 7:
                    ...
                    if(danoVórticeCelestial > 0){
                        System.out.println(nome + " conjurou um vórtice diretamente nos pés do inimigo causando " +danoVórticeCelestial+ " de dano.");
                    }else{
                        System.out.println("Sem mana irmão");
                    }
                    break;
                case 8:
                    ...
                    if(danoPalpatine > 0){
                        System.out.println(nome + " invocou Palpatine dos mortos. Palpatine lança raios no inimigo causando " +danoPalpatine+ " de dano.");
                    }else{
                        System.out.println("Sem mana irmão");
                    }
                    break;
                case 9:
                    ...
                    if(jarJar == 0){
                        System.out.println(nome + " se atrapalhou com a magia e a lançou longe do inimigo causando " +jarJar+ " de dano.");
                    }else{
                        System.out.println("???");
                    }
                    break;
